...
export const typeDef = (type, fromOptions = {}) => {
  ...
  throw new Error(
    `Expected [Object obj] fromOptions, but encountered ${fromOptions}.`
  );
};
...
export const tensorTypeDef = (type, $tensor, fromOptions = {}) => {
  if (typeCheck(Tensor, $tensor)) {
    ...
    throw new Error(
      `Expected [Object obj] options, but encountered ${fromOptions}.`
    );
  }
